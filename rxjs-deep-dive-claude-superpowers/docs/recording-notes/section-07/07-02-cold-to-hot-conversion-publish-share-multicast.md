# 7.2 — Cold-to-hot conversion: publish, share, multicast

**Section:** Multicasting and Hot Streams  
**Companion:** packages/router  
...
**What to open:** `packages/router`  
**Starting state:** git tag `section-07-start`
