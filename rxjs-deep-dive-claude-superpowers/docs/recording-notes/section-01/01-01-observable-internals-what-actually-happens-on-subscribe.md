# 1.1 — Observable internals: what actually happens on subscribe

**Section:** Foundations Revisited  
**Companion:** apps/starter-minimal  
**Wiki sources:** core/observable-internals.md  
...
**What to open:** `apps/starter-minimal`  
**Starting state:** git tag `section-01-start`
