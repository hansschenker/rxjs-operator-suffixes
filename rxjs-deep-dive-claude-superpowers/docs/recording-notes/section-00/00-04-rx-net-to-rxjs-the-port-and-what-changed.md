# 0.4 — Rx.NET to RxJS: the port and what changed

**Section:** RxJS Conceptual and Historical Roots  
**Companion:** (none)  
**Wiki sources:** history/roots.md, history/timeline.md  
...
**What to open:** `(none)`  
**Starting state:** git tag `section-00-start`
