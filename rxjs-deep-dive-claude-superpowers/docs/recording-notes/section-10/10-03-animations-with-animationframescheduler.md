# 10.3 — Animations with animationFrameScheduler

**Section:** Production Patterns  
**Companion:** apps/snake  
**Wiki sources:** patterns/animations.md  
...
**What to open:** `apps/snake`  
**Starting state:** git tag `section-10-start`
