# 5.4 — Global error capture and centralized reporting

**Section:** Error Resilience  
**Companion:** packages/errors  
**Wiki sources:** patterns/error-handling.md  
...
**What to open:** `packages/errors`  
**Starting state:** git tag `section-05-start`
