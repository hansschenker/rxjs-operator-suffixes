# 2.5 — mergeMap: when order truly does not matter

**Section:** Async Coordination  
**Companion:** apps/playground  
**Wiki sources:** core/higher-order-operators.md  
...
**What to open:** `apps/playground`  
**Starting state:** git tag `section-02-start`
