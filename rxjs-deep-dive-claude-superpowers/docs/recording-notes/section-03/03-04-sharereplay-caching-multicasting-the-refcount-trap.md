# 3.4 — shareReplay: caching, multicasting, the refCount trap

**Section:** State Without a Framework  
**Companion:** packages/store  
**Wiki sources:** core/share-replay.md  
...
**What to open:** `packages/store`  
**Starting state:** git tag `section-03-start`
