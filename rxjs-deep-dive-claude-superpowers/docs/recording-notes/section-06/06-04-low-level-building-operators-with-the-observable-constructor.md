# 6.4 — Low-level: building operators with the Observable constructor

**Section:** Custom Operators and Pipeline Composition  
**Companion:** packages/core  
**Wiki sources:** core/custom-operators.md  
...
**What to open:** `packages/core`  
**Starting state:** git tag `section-06-start`
